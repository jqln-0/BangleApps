...
WIDGETS["widtbat"] = { area:"tr", width:32, draw: function() {
  ...
  g.reset().setColor("#000").drawImage(require("heatshrink").decompress(atob("j0TwIHEv///kD////EfAYPwuEAgPB4EAg/HCgMfzgDBvwOC/IOC84ONDoUcFgc/AYOAHYRDE")), this.x + 1, this.y + 4);
